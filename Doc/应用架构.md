...
flowchart LR
    ...
    ST["短期记忆<br/>行程表"]
    L["LLM<br/>豆包系列模型"]
    MAP["高德地图 MCP 工具<br/>天气/POI/附近/距离"]
    DOC["文档查询工具<br/>向量库 FASISS / 嵌入 Qwen3-Embedding-0.6B"]
    OUT["结构化产出<br/>可视化行程板 / 导出"]
    ...
    class U,OUT nodeA;
    class L nodeB;
    class LT,ST,MAP,DOC nodeC;

    classDef nodeA fill:#f9f,stroke:#333,stroke-width:2px;
    classDef nodeB fill:#e1f5fe,stroke:#0277bd,stroke-width:2px;
    classDef nodeC fill:#e8f5e8,stroke:#2e7d32,stroke-width:2px;
```
